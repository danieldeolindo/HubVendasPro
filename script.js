...
const MENU_PADRAO = [
  ...
  { id: "estoque",       icon: "📦", label: "Estoque",      bnav: "Estoque"   },
...
function renderNavs(paginaAtiva) {
  ...
  if (bn) {
    ...
    mais.innerHTML=`<span>☰</span><span>Mais</span>`; mais.onclick=toggleMobileMoreMenu; bn.appendChild(mais);
...
function renderEstoque() {
  ...
  kpis.innerHTML=`<div class="kpi-card"><div class="kpi-icon">📦</div><div class="kpi-label">Produtos cadastrados</div><div class="kpi-value">${totalProdutos}</div></div><div class="kpi-card"><div class="kpi-icon">🔢</div><div class="kpi-label">Unidades em estoque</div><div class="kpi-value green">${totalUnidades}</div></div><div class="kpi-card"><div class="kpi-icon">⚠️</div><div class="kpi-label">Estoque baixo</div><div class="kpi-value">${baixoEstoque}</div></div><div class="kpi-card"><div class="kpi-icon">🚫</div><div class="kpi-label">Sem estoque</div><div class="kpi-value red">${semEstoque}</div></div><div class="kpi-card"><div class="kpi-icon">💰</div><div class="kpi-label">Custo do estoque</div><div class="kpi-value">R$ ${fmt(custoEstoque)}</div></div><div class="kpi-card"><div class="kpi-icon">🏷️</div><div class="kpi-label">Valor de venda</div><div class="kpi-value green">R$ ${fmt(valorEstoque)}</div></div>`;
  if (!produtos.length) { lista.innerHTML=`<div class="empty-state"><span>📦</span>Nenhum produto cadastrado.</div>`; return; }
